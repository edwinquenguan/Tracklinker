...
from app.routes import user_routes, dashboard_routes, category_routes, subcategories_routes, auth_routes, output_details_routes, output_orders_routes, guarantees_routes, reports_routes
