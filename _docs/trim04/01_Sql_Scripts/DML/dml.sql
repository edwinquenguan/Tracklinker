...
(1, null, 'Juan', 'Pérez', 'García', '3004567890', 'juan.perez1@example.com', 'Calle 123 #45-67', sha1('hash_password_1'), '2025-08-20'),
(2, null, 'María', 'López', 'Rodríguez', '3112345678', 'maria.lopez23@example.com', 'Carrera 10 #20-30', sha1('hash_password_2'), '2025-08-19'),
(2, null, 'María', 'López', 'Rodríguez', '3112345678', 'maria.lopez23@example.com', 'Carrera 10 #20-30', sha1('hash_password_2'), '2025-08-19'),
(2, null, 'Carlos', 'García', 'Moreno', '3101112233', 'carlos.garcia@example.com', 'Calle 45 #12-30', sha1('hash_password_18'), '2025-08-20'),
(2, null, 'Andrea', 'López', 'Pérez', '3124445566', 'andrea.lopez@example.com', 'Carrera 20 #5-18', sha1('hash_password_19'), '2025-08-21'),
(2, null, 'Felipe', 'Ramírez', 'Torres', '3157778899', 'felipe.ramirez@example.com', 'Av. Siempre Viva 742', sha1('hash_password_20'), '2025-08-22'),
(2, null, 'Paola', 'Martínez', 'Guzmán', '3163334455', 'paola.martinez@example.com', 'Transv. 56 #34-90', sha1('hash_password_21'), '2025-08-23'),
(2, null, 'Jorge', 'Hernández', 'Suárez', '3176667788', 'jorge.hernandez@example.com', 'Cl. 100 #45-12', sha1('hash_password_22'), '2025-08-24'),
(3, null, 'Carlos', 'Ramírez', 'Torres', '3229876543', 'carlos.ramirez45@example.com', 'Av. Siempre Viva 742', sha1('hash_password_3'), '2025-08-18'),
(3, null, 'Ana', 'Torres', 'Martínez', '3008765432', 'ana.torres12@example.com', 'Calle 50 #10-25', sha1('hash_password_4'), '2025-08-17'),
(3, null, 'Diana', 'Morales', 'Rincón', '3189990011', 'diana.morales@example.com', 'Bodega Central Km 7', sha1('hash_password_23'), '2025-08-25'),
(3, null, 'Ricardo', 'Suárez', 'Castaño', '3192223344', 'ricardo.suarez@example.com', 'Cl. 80 #10-55', sha1('hash_password_24'), '2025-08-26'),
(3, null, 'Lucía', 'Fernández', 'Quintero', '3205556677', 'lucia.fernandez@example.com', 'Carrera 15 #8-44', sha1('hash_password_25'), '2025-08-27'),
(3, null, 'Santiago', 'Rojas', 'Bedoya', '3218889900', 'santiago.rojas@example.com', 'Cl. 30 #22-18', sha1('hash_password_26'), '2025-08-28'),
(3, null, 'Valentina', 'Cárdenas', 'Prieto', '3221112233', 'valentina.cardenas@example.com', 'Zona Industrial 4', sha1('hash_password_27'), '2025-08-29'),
(4, null, 'Luis', 'Gómez', 'Fernández', '3127654321', 'luis.gomez33@example.com', 'Carrera 30 #15-22', sha1('hash_password_5'), '2025-08-16'),
(4, null, 'Juan', 'Perez', 'Lopez', '3151234567', 'juanperez@gmail.com', 'Calle 50 #10-25', sha1('5678'), '1998-05-21'),
(4, null, 'Ana', 'Gomez', ',Martinez', '3109876543', 'anagomez@yahoo.com', 'Calle 50 #10-25', sha1('1234'), '1995-12-10'),
(4, null, 'Carlos', 'Ruiz', 'Garcia', '3123456789', 'carlosr@hotmail.com', 'Calle 50 #10-25', sha1('8765'), '2000-03-15'),
(4, null, 'Laura', 'Jimenez', 'Rodriguez', '3198765432', 'laurajim@gmail.com', 'Calle 50 #10-25', sha1('4321'), '1999-07-30'),
(4, null, 'Pedro', 'Torres', 'Castillo', '3134567890', 'pedrotorres@mail.com', 'Calle 50 #10-25', sha1('9876'), '2001-11-22'),
(4, null, 'Sofia', 'Fernandez', 'Mendez', '3145678901', 'sofiaf@hotmail.com', 'Calle 50 #10-25', sha1('3456'), '1997-08-14'),
(4, null, 'Luis', 'Alvarez', 'Ortiz', '3167890123', 'luisalvarez@gmail.com', 'Calle 50 #10-25', sha1('6543'), '1996-09-05'),
(4, null, 'Martha', 'Vargas', 'Ramos', '3178901234', 'marthav@yahoo.com', 'Calle 50 #10-25', sha1('7890'), '2003-02-17'),
(4, null, 'Andres', 'Castro', 'Morales', '3189012345', 'andrescastro@mail.com', 'Calle 50 #10-25', sha1('2345'), '1994-06-09'),
(4, null, 'Veronica', 'Medina', 'Salazar', '3190123456', 'veronicam@gmail.com', 'Calle 50 #10-25', sha1('6789'), '1993-04-25'),
(4, null, 'Javier', 'Sanchez', 'Hernandez', '3101234567', 'javiers@yahoo.com', 'Calle 50 #10-25', sha1('3456'), '2002-01-13'),
(4, null, 'Laura', 'Diaz', 'Vazquez', '3112345678', 'lauradiaz@gmail.com', 'Calle 50 #10-25', sha1('5678'), '1995-10-02'),
(4, null, 'Miguel', 'Rojas', 'Castro', '3123456789', 'miguelr@mail.com', 'Calle 50 #10-25', sha1('4321'), '1998-03-27'),
(4, null, 'Elena', 'Martinez', 'Sosa', '3134567890', 'elenam@hotmail.com', 'Calle 50 #10-25', sha1('1234'), '2000-12-19');
...
(null, 8, 'Teclados Mecanicos'),
(null, 9, 'Mouse Gamers'),
(null, 10, 'Auriculares Gamers'),
(null, 11, 'Routers'),
(null, 11, 'Switches'),
(null, 11, 'Cables de red'),
(null, 12, 'HDD'),
(null, 12, 'SDD'),
(null, 12, 'NVMe'),
(null, 13, 'Memorias RAM DDR4'),
(null, 13, 'Memorias RAM DDR5');
...
(null, 4, 'HP 110', 'Impresora térmica compacta para etiquetas'),
(null, 3, 'Epson TM-T20', 'Impresora térmica rápida y eficiente'),
(null, 3, 'Epson L3150', 'Multifuncional con sistema de tinta continua'),
(null, 2, 'Canon G2010', 'Impresora continua con escáner'),
(null, 4, 'HP Ink Tank 415', 'Impresora con tinta recargable inalámbrica'),
(null, 4, 'LaserJet Pro M15w', 'Impresora láser compacta y rápida'),
(null, 5, 'Brother HL-L2350DW', 'Impresora láser monocromo'),
(null, 8, 'Samsung Xpress M2020W', 'Impresora láser inalámbrica'),
(null, 8, 'QLED 55Q60A', 'Smart TV Samsung de 55" con resolución 4K'),
(null, 9, 'Bravia XR-55A80K', 'Sony Smart TV OLED 55" 4K'),
(null, 7, 'LED TV 43LM6370', 'LG TV LED 43" Full HD'),
(null, 7, 'OLED TV 65C1', 'TV OLED LG 65" 4K UHD'),
(null, 16, 'WD My Passport 1TB', 'Disco duro externo portátil con USB 3.0'),
(null, 20, 'Logitech MX Keys', 'Teclado inalámbrico retroiluminado'),
(null, 21, 'Razer DeathAdder V2', 'Mouse gamer ergonómico'),
(null, 22, 'HyperX Cloud II', 'Auriculares gamer con sonido envolvente'),
(null, 23, 'TP-Link Archer AX50', 'Router WiFi 6 de alta velocidad'),
(null, 24, 'Cisco SG350-28', 'Switch gestionable de 28 puertos'),
(null, 24, 'Cable Cat6 UTP', 'Cable de red de 2 metros'),
(null, 10, 'Lenovo ThinkPad X1 Carbon', 'Portátil ultraligero con procesador Intel i7 y 16GB RAM'),
(null, 11, 'Asus ROG Strix G15', 'Laptop gamer con RTX 3060 y 16GB RAM'),
(null, 25, 'MacBook Pro 14"', 'Laptop Apple con chip M1 Pro y pantalla Retina'),
(null, 7,  'LG NanoCell 55NANO80', 'Smart TV LG 55” con tecnología NanoCell 4K'),
(null, 17, 'Kioxia Exceria 500GB', 'Disco SSD NVMe de alta velocidad'),
(null, 18, 'Kingston Fury Beast 16GB DDR4', 'Memoria RAM para alto rendimiento'),
(null, 19, 'Crucial Ballistix 32GB DDR5', 'Memoria RAM DDR5 para gaming y servidores'),
(null, 20, 'Logitech G Pro X', 'Teclado mecánico gamer con switches intercambiables'),
(null, 21, 'Razer Viper Ultimate', 'Mouse inalámbrico gamer ultraligero con 20K DPI'),
(null, 22, 'HyperX Alpha Wireless', 'Auriculares inalámbricos gamer con batería de 300h'),
(null, 23, 'TP-Link Deco X60', 'Sistema WiFi Mesh con cobertura para hogares grandes'),
(null, 24, 'Cisco Catalyst 9300', 'Switch empresarial de alto rendimiento');
...
(null, 16, 'INP00001', '2024-05-05'),
(null, 2, 'INP00002', '2024-05-05'),
(null, 16, 'INP00002', '2024-05-05'),
(null, 16, 'INP00003', '2024-05-10'),
(null, 18, 'INP00005', '2024-05-15'),
(null, 17, 'INP00006', '2024-05-18'),
(null, 2, 'INP00007', '2024-05-20'),
(null, 2, 'INP00008', '2024-05-22'),
(null, 1, 'INP00009', '2024-05-25'),
(null, 2, 'INP00010', '2024-05-28'),
(null, 15, 'INP00011', '2024-06-01'),
(null, 16, 'INP00012', '2024-06-05'),
(null, 2, 'INP00013', '2024-06-08'),
(null, 2, 'INP00014', '2024-06-10'),
(null, 12, 'INP00015', '2024-06-15'),
(null, 4, 'INP00016', '2024-06-20'),
(null, 8, 'INP00017', '2024-06-25'),
(null, 2, 'INP00018', '2025-06-26'),
(null, 2, 'INP00019', '2025-07-01'),
(null, 5, 'INP00020', '2025-07-05'),
(null, 11, 'INP00021', '2025-07-15'),
(null, 9, 'INP00022', '2025-07-15'),
(null, 5, 'INP00023', '2025-07-15'),
(null, 10, 'INP00024', '2025-07-15'),
(null, 1, 'INP00025', '2025-07-15'),
(null, 3, 'INP00026', '2025-07-15');
...
(null, 'QTYC1123122', 'Juan Perez', '3008765432', 'Calle 50 #10-25', 'Problema con la impresión', '../warranties/images/WINC0001', 'Miami', '2025-08-15', 0),
(null, 'QTYA9876543', 'Ana Gomez', '3008765432', 'Calle 50 #10-25', 'Problema con la impresión', '../warranties/images/WINC0001', 'Miami', '2025-08-15', 0),
(null, 'QTYB5554441', 'Carlos Ruiz', '3002223344', 'Calle 80 #45-10', 'Teclado no enciende retroiluminación', '../warranties/images/WINC0002', 'Bogotá', '2025-09-01', 0),
...
(null, 'QTYG7778889', 'Sofia Fernandez', '3015556677', 'Carrera 15 #22-55', 'Mouse con sensor defectuoso', '../warranties/images/WINC0003', 'Medellín', '2025-09-02', 0),
(null, 'QTYH5556667', 'Luiz Alvarez', '3015556677', 'Carrera 15 #22-55', 'Mouse con sensor defectuoso', '../warranties/images/WINC0003', 'Medellín', '2025-09-02', 0),
(null, 'QTYI9990001', 'Martha Vargas', '3015556677', 'Carrera 15 #22-55', 'Mouse con sensor defectuoso', '../warranties/images/WINC0003', 'Medellín', '2025-09-02', 0);
