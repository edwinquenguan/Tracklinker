...
import { useSuppliersAreaData } from "../../../../hooks/suppliers/useSuppliersAreaData.js";

export default function SuppliersAreaChart({ period }) {
  const { suppliersData } = useSuppliersAreaData(period);
  return (
