...
import { useWarrantiesAreaData } from "../../../../hooks/warranties/useWarrantiesAreaData";

export default function WarrantiesAreaChart({ period }) {
  const { warrantiesData } = useWarrantiesAreaData(period);
  return (
