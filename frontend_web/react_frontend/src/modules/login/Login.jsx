...
export default function Login() {
  ...
  return (
    <section className="w-[100%] h-[100%] flex place-items-center justify-center">
      <section
        className="flex flex-col min-w-[600px] items-center p-4 bg-neutral-200 shadow-[0px_0px_20px_5px_#e5e5e5] rounded-2xl
          ...
          <section className="flex flex-col p-3 gap-2">
            ...
            <button
              ...
              className="flex justify-center px-8 py-4 text-base rounded-xl transition duration-300
                        ...
                        dark:text-white dark:hover:shadow-[0px_0px_20px_0px_#2020226c] dark:hover:bg-[#2020226c]"
            >
              {" "}
              Registrarme{" "}
            </button>
