        ...
        >
          ...
          {modalType === "info" && (
            <div className="flex flex-col justify-center">
              <p>
                <strong>Nombre:</strong> {selectedSupplier.supplier_name}
              </p>
              <p>
                <strong>Ciudad:</strong> {selectedSupplier.supplier_city}
              </p>
              <p>
                <strong>Teléfono:</strong> {selectedSupplier.supplier_phone}
              </p>
              <p>
                <strong>Dirección:</strong> {selectedSupplier.supplier_address}
              </p>
              <p>
                <strong>Fecha De Creación:</strong>{" "}
                {selectedSupplier.supplier_date}
              </p>
            </div>
          )}
