  ...
  return (
    <section className="flex flex-col items-center">
      <form action="" className="flex flex-col gap-1">
        <SelectMenu width={"64"} spanText={"Categoria"}>
        ...
        <SelectMenu width={"64"} spanText={"Subcategoria"}>
        ...
        <FormField
          ...
          id={"model"}
        />
        <FormField labelText={"Serial"} placeholder={"10KQ340"} id={"serial"} />
        <SelectMenu width={"64"} spanText={"Tiempo De Garantía"}>
        ...
        <section className="flex items-center justify-center">
          <button
            className="flex items-center py-2 px-4 gap-2 border rounded-lg transition duration-300 
                    hover:bg-gray-300
