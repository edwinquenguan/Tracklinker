...
export default function ReportTranformationsModal({confirmButtonOnClick, cancelButtonOnClick}){
    return(
        <section className="flex flex-col items-center gap-2">
            ...
            spanText={"Quiero Un Informe De:"}>
                <option value="date-range"> Tranformaciones Creadas en las fechas </option>
                <option value="delete-range"> Tranformaciones Eliminadas en las fechas </option>
