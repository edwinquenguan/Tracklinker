...
export default function ReportCategoriesModal({confirmButtonOnClick, cancelButtonOnClick}){
    return(
        <section className="flex flex-col items-center gap-2">
            ...
            spanText={"Quiero Un Informe De:"}>
                ...
                <option value="delete-range"> Categorias Eliminadas en las fechas </option>
