export default function TranformationCard({transformationId, transformationRequirement, transformationCreateDate, transformationStatusIcon, transformationStatus, onClick}) {
    return(
        <section className="max-w-80 h-50 max-h-56 p-4 flex flex-col gap-2 rounded-xl shadow-gray-400 shadow-sm border">
            <span className="text-lg font-semibold dark:text-white">ID: {transformationId}</span>
            ...
            <section className="flex flex-col">
                ...
                <div className="flex justify-between">
                    <div className="flex items-center gap-2">
                        <img src={transformationStatusIcon} alt="" className="w-[20px] h-[20px]"/>
