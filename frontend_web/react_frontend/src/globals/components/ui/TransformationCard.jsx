export default function TranformationCard({transformationId, transformationRequirement, transformationCreateDate, transformationStatusIcon, transformationStatus}) {
    return(
